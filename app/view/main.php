      ...
      <div id="collapse<?php print_r($key) ?>" class="panel-collapse collapse in">
        <table class='table'>
          ...
          <tr>
            ...
            <td></td>
            <td class='text-center'><b><?php print_r($squad->getFinalAverages()['shooting']); ?></b></td>
            <td class='text-center'><b><?php print_r($squad->getFinalAverages()['skating']); ?></b></td>
            <td class='text-center'><b><?php print_r($squad->getFinalAverages()['checking']); ?></b></td>
          </tr>
        </table>
      </div>
    </div>
